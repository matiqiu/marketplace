...
if(isset($_POST['guardar-clave'])){
    ...
    //redirigir a notificcacion de actualizacion correcta y ofrecer link a login
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h4>Crea una contraseña nueva</h4>
                </div>   
                <div class="panel-body">
                    <form role="form" method="post" action="<?php echo RUTA_RECUPERACION_CLAVE. "/".$url_personal; ?>">
                        ...
                        <button type="submit" name="guardar-clave" class="btn btn-lg btn-default btn-block">
                            Guardar contraseña
                        </button>
                    </form>
                </div>
