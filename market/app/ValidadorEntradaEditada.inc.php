...
class ValidadorEntradaEditada extends Validador {
    ...
    public function __construct($titulo, $titulo_original, $valor, $valor_original, $url, $url_original, $texto, $texto_original, $checkbox, $checkbox_original, $conexion) {
        $this->titulo = $this->devolver_variable_si_iniciada($titulo);
        $this->valor = $this->devolver_variable_si_iniciada($valor);
        ...
        $this->valor_original = $this->devolver_variable_si_iniciada($valor_original);
        ...
        if ($this->cambios_realizados) {
            ...
            if ($this -> valor !== $this -> valor_original){
                $this -> error_valor = $this -> validar_valor($conexion, $this -> valor);
            } else {
                $this -> error_valor = "";
            }
    ...
    public function obtener_valor_original(){
