<div class="row parte-gestor-entradas">
    <div class="col-md-12">
        ...
        <br>
        <a href="<?php echo RUTA_NUEVA_ENTRADA ?>" class="btn btn-lg btn-default" role="button">Nuevo artículo</a>
        <br>
        <br>
    </div>
</div>
<div class="row parte-gestor-entradas">
    <div class="col-md-12">
        ...
        if (count($array_entradas) > 0) {
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < count($array_entradas); $i++) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="<?php echo RUTA_ENTRADA . '/' . $entrada_actual->obtener_url(); ?>">
                                    <input type="hidden" name="id_ver" value="<?php echo $entrada_actual->obtener_id(); ?>">
                                    <button type="submit" class="btn btn-default btn-xs" name="ver_entrada">Ver</button>
                                </form>
                            </td>
                            <td>
            ...
            ?>
            <h3 class="text-center">Todavía no has escrio ninguna entrada</h3>
            <br>
            <br>
            <?php
        }
