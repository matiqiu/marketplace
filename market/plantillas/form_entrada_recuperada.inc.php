...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="valor" name="valor" placeholder="$999"
           value="<?php echo $entrada_recuperada->obtener_valor(); ?>">
    <input type="hidden" id="valor-original" name="valor-original" value="<?php echo $entrada_recuperada->obtener_valor(); ?>" >
</div> 
<div class="form-group">
    <label for="url">URL</label>
    <input type="text" class="form-control" id="url" name="url" placeholder="ej: nombre-sin-espacios" value="<?php echo $entrada_recuperada->obtener_url(); ?>">
    <input type="hidden" id="url-original" name="url-original" value="<?php echo $entrada_recuperada->obtener_url(); ?>" >
</div> 
<div class="form-group">
    <label for="contenido">Contenido</label>
    <textarea class="form-control" rows="10" id="texto"name="texto"><?php echo $entrada_recuperada->obtener_texto(); ?></textarea>
...
<div class="checkbox">
    <label>
        <input type="checkbox" id="publicar" name="publicar" value="si" <?php if ($entrada_recuperada->obtener_activa()) echo 'checked' ?>>Marca este recuadro si quieres mandar de inmediato el articulo.
